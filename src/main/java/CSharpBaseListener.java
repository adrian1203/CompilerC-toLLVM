...
public class CSharpBaseListener implements CSharpListener {
     ...
     */
    @Override
    public void enterProgram(CSharpParser.ProgramContext ctx) {
    }
     ...
     */
    @Override
    public void exitProgram(CSharpParser.ProgramContext ctx) {
    }
     ...
     */
    @Override
    public void enterDeclarationList(CSharpParser.DeclarationListContext ctx) {
    }
     ...
     */
    @Override
    public void exitDeclarationList(CSharpParser.DeclarationListContext ctx) {
    }
     ...
     */
    @Override
    public void enterLogicalStatement(CSharpParser.LogicalStatementContext ctx) {
        if (ctx.Boolean() != null) {
     ...
     */
    @Override
    public void exitLogicalStatement(CSharpParser.LogicalStatementContext ctx) {
        if (ctx.Boolean() == null) {
            ...
            String label1=valueQueue.poll();
            String label2=valueQueue.poll();
            if(label1.matches("[a-zA-Z]")){
                translate+=label1+", ";
            }else{
...
//			translate+=stackTrue.pop().toString()+":";
    ...
    @Override
    public void enterExpressionAssigment(CSharpParser.ExpressionAssigmentContext ctx) {

    }

    @Override
    public void exitExpressionAssigment(CSharpParser.ExpressionAssigmentContext ctx) {

        ctx.variableDec().VarName();
        String lastLabel = "";
        while (!labelValueQueue.isEmpty()) {
            lastLabel = labelValueQueue.poll() + "\n";
            translate += lastLabel;
        }
        if (ctx.variableDec().varType().FloatType() != null) {
            translate += "store float %" + valueQueue.poll() + ", %" + ctx.variableDec().VarName().toString();
        } else if (ctx.variableDec().varType().IntegerType() != null) {
            translate += "store i32 %" + valueQueue.poll() + ", %" + ctx.variableDec().VarName().toString();
        } else if (ctx.variableDec().varType().DoubleType() != null) {
            translate += "store double %" + valueQueue.poll() + ", %" + ctx.variableDec().VarName().toString();
        }
        translate += "\n";
     ...
     */
    @Override
    public void enterInstructionsBlock(CSharpParser.InstructionsBlockContext ctx) {
    }
     ...
     */
    @Override
    public void exitInstructionsBlock(CSharpParser.InstructionsBlockContext ctx) {
    }
     ...
     */
    @Override
    public void enterDeclaration(CSharpParser.DeclarationContext ctx) {
    }
     ...
     */
    @Override
    public void exitDeclaration(CSharpParser.DeclarationContext ctx) {
    }
     ...
     */
    @Override
    public void enterVariableDec(CSharpParser.VariableDecContext ctx) {
    }
     ...
     */
    @Override
    public void exitVariableDec(CSharpParser.VariableDecContext ctx) {
     ...
     */
    @Override
    public void enterArrayDec(CSharpParser.ArrayDecContext ctx) {
    }
     ...
     */
    @Override
    public void exitArrayDec(CSharpParser.ArrayDecContext ctx) {
    }
     ...
     */
    @Override
    public void enterArrayVal(CSharpParser.ArrayValContext ctx) {
    }
     ...
     */
    @Override
    public void exitArrayVal(CSharpParser.ArrayValContext ctx) {
    }
     ...
     */
    @Override
    public void enterVarType(CSharpParser.VarTypeContext ctx) {
    }
     ...
     */
    @Override
    public void exitVarType(CSharpParser.VarTypeContext ctx) {
    }
     ...
     */
    @Override
    public void enterValue(CSharpParser.ValueContext ctx) {

        if (ctx.MathOperator(0) == null) {
            if (ctx.VarName(0) != null)
                valueQueue.add(ctx.VarName(0).toString());
            else if (ctx.Integer(0) != null) {
                valueQueue.add(ctx.Integer(0).toString());
            } else if (ctx.Float(0) != null) {
                valueQueue.add(ctx.Float(0).toString());
            } else if (ctx.String(0) != null) {
                valueQueue.add(ctx.String(0).toString());
            } else if (ctx.CharAss(0) != null) {
                valueQueue.add(ctx.CharAss(0).toString());
            }
     ...
     */
    @Override
    public void exitValue(CSharpParser.ValueContext ctx) {
    }
    ...
    public void enterForAssigment(CSharpParser.ForAssigmentContext ctx) {
        if (ctx.IntegerType() != null) {
            translate += "@" + ctx.VarName().toString() + ctx.EqualMark().toString() + "global i32 " + ctx.Integer().toString() + ", aligin 8\n";
